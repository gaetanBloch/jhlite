...
@UnitTest
class Jhlite110CollectionsTest {

  @Nested
  @DisplayName("Collections")
  class Jhlite110CollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = Jhlite110Collections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = Jhlite110Collections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class Jhlite110CollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = Jhlite110Collections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = Jhlite110Collections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class Jhlite110CollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = Jhlite110Collections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = Jhlite110Collections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class Jhlite110MapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = Jhlite110Collections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = Jhlite110Collections.immutable(input);
